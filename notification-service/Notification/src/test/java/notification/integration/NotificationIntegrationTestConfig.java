...
class NotificationIntegrationTestConfig {
    ...
    ConcurrentKafkaListenerContainerFactory<String, VerifyEmailPayload> kafkaListenerContainerFactory() {
        Map<String, Object> properties = Map.of(
                ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:9092",
                ConsumerConfig.GROUP_ID_CONFIG, "notification-integration-test",
                ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class,
                ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class,
                JsonDeserializer.VALUE_DEFAULT_TYPE, VerifyEmailPayload.class.getName(),
        ...
        // saveMessage(record) вызываем напрямую, поэтому Kafka broker не нужен.
