...
public class KafkaTopicsConfig {
    ...
    @Bean
    public ConsumerFactory<String, VerifyEmailPayload> verificationEmailConsumerFactory(
            @Value("${spring.kafka.bootstrap-servers}") String bootstrapServers) {
        Map<String, Object> properties = new HashMap<>();
        ...
        properties.put(JsonDeserializer.VALUE_DEFAULT_TYPE, VerifyEmailPayload.class.getName());
    ...
    public ConcurrentKafkaListenerContainerFactory<String, VerifyEmailPayload> kafkaListenerContainerFactory(
            ConsumerFactory<String, VerifyEmailPayload> verificationEmailConsumerFactory,
            DefaultErrorHandler errorHandler) {
        ConcurrentKafkaListenerContainerFactory<String, VerifyEmailPayload> factory =
