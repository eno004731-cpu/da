package legal_website.config.kafka;
...
public class KafkaApplication {
    ...
    @Bean
    public ProducerFactory<String, VerifyEmailPayload> verificationEmailProducerFactory(
    ...
    @Bean
    public KafkaTemplate<String, VerifyEmailPayload> verificationEmailKafkaTemplate(
            ProducerFactory<String, VerifyEmailPayload> verificationEmailProducerFactory) {
