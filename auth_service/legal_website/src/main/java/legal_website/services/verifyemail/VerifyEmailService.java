...
public class VerifyEmailService {
    ...
    @Transactional
    public VerifyEmailResponse sendCode(Long id){
        ...
        VerifyEmailPayload kafkaPayload = createVerifyEmailPayload(user, codeEntity);
        try {
        ...
        VerifyEmailResponse response = makeVerifyEmailResponse(user);

        return response;
    }
    private VerifyEmailPayload createVerifyEmailPayload(UserEntity user, VerificationCodeEntity codeEntity){
        VerifyEmailPayload kafkaPayload = new VerifyEmailPayload();
    ...
    private VerifyEmailResponse makeVerifyEmailResponse(UserEntity user){
